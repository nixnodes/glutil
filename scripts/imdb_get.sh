...
#@MACRO:imdb-su:{m:exe} -a --imdblog={m:q:imdb@file} --silent -v --loglevel=5 --preexec "{m:exe} -v --backup imdb" -execv "{m:spec1} {dir} {exe} {imdbfile} {glroot} {siterootn} {dir} 1 {year}" 
#@MACRO:imdb-su-id:{m:exe} -a --imdblog={m:q:imdb@file} --silent -v --loglevel=5 --preexec "{m:exe} -v --backup imdb" -execv "{m:spec1} {imdbid} {exe} {imdbfile} {glroot} {siterootn} {dir} 2 {basedir} {year}" 
#@MACRO:imdb-su-f1:{m:exe} -a --imdblog={m:q:imdb@file} --silent -v --loglevel=5 --preexec "{m:exe} -v --backup imdb" -execv "{m:spec1} {dir} {exe} {imdbfile} {glroot} {siterootn} {dir} 1" iregex "dir,\/"
