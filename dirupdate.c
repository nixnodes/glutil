...
static uLong crc_32_tab[] = { /* CRC polynomial 0xedb88320 */0x00000000, 0x77073096, 0xee0e612c, 0x990951ba, 0x076dc419, 0x706af48f,
...
char *hpd_up =
		"glFTPd dirlog tool, version %d.%d-%d%s-%s\n"
				...
				"  --dirlog=FILE         Override default path to dirlog file\n"
				"  --nukelog=FILE        Override default path to nukelog file\n"
