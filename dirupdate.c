 ...
 *   - Bugfix: backups weren't getting created before certain operations (rev. 7)
 *
 *
 * v0.8:
 *
 ...
 * 		and nukelog data (see 'Folders file' description below)
 *  - Rebuild existing dirlog using regex/custom filtering methods
 ...
 * Installation:
 *
 *  - Copy dirupdate.c to /<glroot>/bin/sources
 *  - Install zlib development files (for crc32 calc)
 *  - Compile:
 *
 *      cd /<glroot>/bin/sources
 *      wget http://testing.nixnodes.net/c/dirupdate.c
 *      cc dirupdate.c -o ../dirupdate -lz -Wall -O3
 *
 *      Some warnings might pop up (should be safe)
 *
 *
 * Folders file (recursive rebuild only):
 *
