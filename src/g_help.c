...
char *hpd_up =
    ...
    "  -q <dirlog|nukelog|dupefile|lastonlog|imdb|game|tvrage|ge1|ge2|ge3|ge4|sconf|gconf|altlog|x> [--raw] [--batch] [-E] [-print] ..\n"
    "                        Read specified log\n"
    "  -t                    Read all user files inside /ftp-data/users\n"
    "  -g                    Read all group files inside /ftp-data/groups\n"
    "  -x <root dir> [-R] [filters..] [--maxdepth=<limit>] [--mindepth=<limit>] [-print] [ --r[u]sleep] [--raw]..\n"
    ...
    "                          --xflags <field1|field2|..> - used with --raw, select what data to include in the output,\n"
    "                                                        default is everything except crc32 fields\n"
    ...
    "                          Expressions inside parentheses do NOT force precedence, rather a mathematical expression is expected\n"
    ...
    "  -fd: [..] <expr>      Same as -prune:\n"
    "  -l: <field>           Performs the next string match (-regex, -name, ..) against <field>\n"
    "\n Hooks:\n"
    ...
    "  --stdlog <[-]filter|[-]filter|..> \n"
    "                        Filter stdout output\n"
    "                           Valid <filter> options: <exception|error|warning|notice|info|macro|stats|other|debug[0-9]|normal|important|all>\n"
    "                           Prepend '-' to an option to explicitly disable an output type\n"
    "  --stdlvl <0-32>       Filter stdout output by level\n"
