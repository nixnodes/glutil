...
__g_proc_rv dt_rval_nukelog_size, dt_rval_nukelog_time, dt_rval_nukelog_status,
    ...
    dt_rval_nukelog_unnuker, dt_rval_nukelog_reason, dt_rval_x_nukelog,
    dt_rval_xg_nukelog;

__d_format_block nukelog_format_block, nukelog_format_block_batch,
    nukelog_format_block_exp;
