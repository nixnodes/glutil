...
__d_comp g_is_higher_s, g_is_lower_s, g_is_higherorequal_s, g_is_equal_S,
    g_is_not_equal_s, g_is_lowerorequal_s, g_is_not_s, g_is_s, g_is_lower_2_s,
    g_is_higher_2_s, g_is_equal_s;

__d_comp g_is_higher, g_is_lower, g_is_higherorequal, g_is_equal,
    g_is_not_equal, g_is_lowerorequal, g_is_not, g_is, g_is_lower_2,
    g_is_higher_2, g_is_equal;

__d_comp g_is_lower_f, g_is_higher_f, g_is_higherorequal_f, g_is_equal_f,
